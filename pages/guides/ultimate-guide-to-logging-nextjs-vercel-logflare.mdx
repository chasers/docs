...
export const meta = {
  ...
  lastEdited: '2020-06-23T20:40:22.000Z',
...
Logs are an important part of running an app to understand what's going on at any point in time and Vercel has put in a lot of work into enabling the easy collection of logs via Serverless Functions in co-operation with platforms that specialize in dealing with logs, such as <Link href="https://logflare.app" target="_blank">Logflare</Link>.
...
<Video
  src={`https://p195.p4.n0.cdn.getcloudapp.com/items/04uYA7eX/trimmed-logflare-preview-vercel.mp4`}
  width={1440 / 1.5}
  height={900 / 1.5}
  oversize
  controls
