...
export const meta = {
  ...
  lastEdited: '2020-06-22T19:16:47.000Z',
...
Logs are an important part of running an app to understand what's going on at any point in time and Vercel has put in a lot of work into enabling the easy collection of logs via Serverless Functions in co-operation with platforms that specialize in dealing with logs, such as Logflare.
...
<Video
  src={`https://p195.p4.n0.cdn.getcloudapp.com/items/nOuelOom/quick-logflare-vercel-demo.mp4`}
  width={1440 / 1.5}
  height={900 / 1.5}
  oversize
  controls
  muted={false}
  autoPlay={false}
  caption={'Quick Logflare + Vercel + Next.js demo'}
  loop={false}
/>

## What You'll Get with Logflare

Logflare automatically parses the stringy JSON log lines that Vercel sends, making them easily queryable with the Logflare Query Language (or even just SQL).
...
🎉 Let's get started! Deploy the example repo.
